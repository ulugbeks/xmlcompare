...
@section('title', 'Change Email - Shop Profile')
    ...
    <div class="profile__container">
        <div class="profile__wrapp">
            ...
            <div class="profile__block">
                ...
                <form action="{{ route('shop.profile.email.update') }}" method="POST">
                    @csrf
                    <div class="input-wrapp">
                        <input autocomplete="off" type="text" name="old_email" data-error="Error!"
                            placeholder="Old Email" class="input @error('old_email') is-invalid @enderror" 
                            value="{{ auth()->user()->email }}" readonly data-required="email">
                        @error('old_email')
